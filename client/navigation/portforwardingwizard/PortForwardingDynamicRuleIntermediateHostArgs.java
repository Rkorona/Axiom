...
public class PortForwardingDynamicRuleIntermediateHostArgs implements w {
    private final HashMap arguments;

    public static final class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final HashMap f29394a;
        ...
        public PortForwardingDynamicRuleIntermediateHostArgs a() {
            return new PortForwardingDynamicRuleIntermediateHostArgs(this.f29394a);
        }
    }

    public static PortForwardingDynamicRuleIntermediateHostArgs fromBundle(Bundle bundle) {
        PortForwardingDynamicRuleIntermediateHostArgs portForwardingDynamicRuleIntermediateHostArgs = new PortForwardingDynamicRuleIntermediateHostArgs();
        bundle.setClassLoader(PortForwardingDynamicRuleIntermediateHostArgs.class.getClassLoader());
        ...
        portForwardingDynamicRuleIntermediateHostArgs.arguments.put("wizardData", portForwardingWizardData);
        return portForwardingDynamicRuleIntermediateHostArgs;
    }

    public static PortForwardingDynamicRuleIntermediateHostArgs fromSavedStateHandle(u0 u0Var) {
        PortForwardingDynamicRuleIntermediateHostArgs portForwardingDynamicRuleIntermediateHostArgs = new PortForwardingDynamicRuleIntermediateHostArgs();
    ...
    public boolean equals(Object obj) {
        ...
        PortForwardingDynamicRuleIntermediateHostArgs portForwardingDynamicRuleIntermediateHostArgs = (PortForwardingDynamicRuleIntermediateHostArgs) obj;
        if (this.arguments.containsKey("wizardData") != portForwardingDynamicRuleIntermediateHostArgs.arguments.containsKey("wizardData")) {
            return false;
        }
        return getWizardData() == null ? portForwardingDynamicRuleIntermediateHostArgs.getWizardData() == null : getWizardData().equals(portForwardingDynamicRuleIntermediateHostArgs.getWizardData());
    }
    ...
    public String toString() {
        return "PortForwardingDynamicRuleIntermediateHostArgs{wizardData=" + getWizardData() + "}";
    }

    private PortForwardingDynamicRuleIntermediateHostArgs() {
        this.arguments = new HashMap();
    }

    private PortForwardingDynamicRuleIntermediateHostArgs(HashMap map) {
