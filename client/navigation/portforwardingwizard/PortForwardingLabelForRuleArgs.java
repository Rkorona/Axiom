...
public class PortForwardingLabelForRuleArgs implements w {
    private final HashMap arguments;

    public static final class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final HashMap f29433a;
        ...
        public PortForwardingLabelForRuleArgs a() {
            return new PortForwardingLabelForRuleArgs(this.f29433a);
        }
    }

    public static PortForwardingLabelForRuleArgs fromBundle(Bundle bundle) {
        PortForwardingLabelForRuleArgs portForwardingLabelForRuleArgs = new PortForwardingLabelForRuleArgs();
        bundle.setClassLoader(PortForwardingLabelForRuleArgs.class.getClassLoader());
        ...
        portForwardingLabelForRuleArgs.arguments.put("wizardData", portForwardingWizardData);
        return portForwardingLabelForRuleArgs;
    }

    public static PortForwardingLabelForRuleArgs fromSavedStateHandle(u0 u0Var) {
        PortForwardingLabelForRuleArgs portForwardingLabelForRuleArgs = new PortForwardingLabelForRuleArgs();
    ...
    public boolean equals(Object obj) {
        ...
        PortForwardingLabelForRuleArgs portForwardingLabelForRuleArgs = (PortForwardingLabelForRuleArgs) obj;
        if (this.arguments.containsKey("wizardData") != portForwardingLabelForRuleArgs.arguments.containsKey("wizardData")) {
            return false;
        }
        return getWizardData() == null ? portForwardingLabelForRuleArgs.getWizardData() == null : getWizardData().equals(portForwardingLabelForRuleArgs.getWizardData());
    }
    ...
    public String toString() {
        return "PortForwardingLabelForRuleArgs{wizardData=" + getWizardData() + "}";
    }

    private PortForwardingLabelForRuleArgs() {
        this.arguments = new HashMap();
    }

    private PortForwardingLabelForRuleArgs(HashMap map) {
