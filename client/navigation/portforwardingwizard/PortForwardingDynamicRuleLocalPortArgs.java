...
public class PortForwardingDynamicRuleLocalPortArgs implements w {
    private final HashMap arguments;

    public static final class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final HashMap f29415a;
        ...
        public PortForwardingDynamicRuleLocalPortArgs a() {
            return new PortForwardingDynamicRuleLocalPortArgs(this.f29415a);
        }
    }

    public static PortForwardingDynamicRuleLocalPortArgs fromBundle(Bundle bundle) {
        PortForwardingDynamicRuleLocalPortArgs portForwardingDynamicRuleLocalPortArgs = new PortForwardingDynamicRuleLocalPortArgs();
        bundle.setClassLoader(PortForwardingDynamicRuleLocalPortArgs.class.getClassLoader());
        ...
        portForwardingDynamicRuleLocalPortArgs.arguments.put("wizardData", portForwardingWizardData);
        return portForwardingDynamicRuleLocalPortArgs;
    }

    public static PortForwardingDynamicRuleLocalPortArgs fromSavedStateHandle(u0 u0Var) {
        PortForwardingDynamicRuleLocalPortArgs portForwardingDynamicRuleLocalPortArgs = new PortForwardingDynamicRuleLocalPortArgs();
    ...
    public boolean equals(Object obj) {
        ...
        PortForwardingDynamicRuleLocalPortArgs portForwardingDynamicRuleLocalPortArgs = (PortForwardingDynamicRuleLocalPortArgs) obj;
        if (this.arguments.containsKey("wizardData") != portForwardingDynamicRuleLocalPortArgs.arguments.containsKey("wizardData")) {
            return false;
        }
        return getWizardData() == null ? portForwardingDynamicRuleLocalPortArgs.getWizardData() == null : getWizardData().equals(portForwardingDynamicRuleLocalPortArgs.getWizardData());
    }
    ...
    public String toString() {
        return "PortForwardingDynamicRuleLocalPortArgs{wizardData=" + getWizardData() + "}";
    }

    private PortForwardingDynamicRuleLocalPortArgs() {
        this.arguments = new HashMap();
    }

    private PortForwardingDynamicRuleLocalPortArgs(HashMap map) {
