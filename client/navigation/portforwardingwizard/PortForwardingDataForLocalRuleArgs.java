...
public class PortForwardingDataForLocalRuleArgs implements w {
    private final HashMap arguments;

    public static final class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final HashMap f29357a;
        ...
        public PortForwardingDataForLocalRuleArgs a() {
            return new PortForwardingDataForLocalRuleArgs(this.f29357a);
        }
    }

    public static PortForwardingDataForLocalRuleArgs fromBundle(Bundle bundle) {
        PortForwardingDataForLocalRuleArgs portForwardingDataForLocalRuleArgs = new PortForwardingDataForLocalRuleArgs();
        bundle.setClassLoader(PortForwardingDataForLocalRuleArgs.class.getClassLoader());
        ...
        portForwardingDataForLocalRuleArgs.arguments.put("wizardData", portForwardingWizardData);
        return portForwardingDataForLocalRuleArgs;
    }

    public static PortForwardingDataForLocalRuleArgs fromSavedStateHandle(u0 u0Var) {
        PortForwardingDataForLocalRuleArgs portForwardingDataForLocalRuleArgs = new PortForwardingDataForLocalRuleArgs();
    ...
    public boolean equals(Object obj) {
        ...
        PortForwardingDataForLocalRuleArgs portForwardingDataForLocalRuleArgs = (PortForwardingDataForLocalRuleArgs) obj;
        if (this.arguments.containsKey("wizardData") != portForwardingDataForLocalRuleArgs.arguments.containsKey("wizardData")) {
            return false;
        }
        return getWizardData() == null ? portForwardingDataForLocalRuleArgs.getWizardData() == null : getWizardData().equals(portForwardingDataForLocalRuleArgs.getWizardData());
    }
    ...
    public String toString() {
        return "PortForwardingDataForLocalRuleArgs{wizardData=" + getWizardData() + "}";
    }

    private PortForwardingDataForLocalRuleArgs() {
        this.arguments = new HashMap();
    }

    private PortForwardingDataForLocalRuleArgs(HashMap map) {
