...
public final class TriggerSendEmailCodeRepository {
    ...
    private final SyncRestApiClientFactory f39242a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final g0 f39243b;
    ...
    public interface Result {
        ...
        public static final class RecaptchaRequired implements Result {
            public static final int $stable = 0;
            public static final RecaptchaRequired INSTANCE = new RecaptchaRequired();

            private RecaptchaRequired() {
            }

            public boolean equals(Object obj) {
                return this == obj || (obj instanceof RecaptchaRequired);
            }
    ...
    static final class b extends d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f39244a = obj;
            this.f39246c |= RtlSpacingHelper.UNDEFINED;
            return TriggerSendEmailCodeRepository.this.b(null, null, this);
        }
    }
    ...
    static final class c extends m implements p {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ SyncRestInterface f39248b;
        ...
        c(SyncRestInterface syncRestInterface, String str, String str2, e eVar) {
            super(2, eVar);
            this.f39248b = syncRestInterface;
            this.f39249c = str;
            this.f39250d = str2;
        }
        ...
        public final e create(Object obj, e eVar) {
            return new c(this.f39248b, this.f39249c, this.f39250d, eVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            x.b(obj);
            SyncRestInterface syncRestInterface = this.f39248b;
            TriggerSendEmailCodeRequest triggerSendEmailCodeRequest = new TriggerSendEmailCodeRequest(this.f39249c, this.f39250d);
            this.f39247a = 1;
            Object objTriggerSendEmailCode = syncRestInterface.triggerSendEmailCode(triggerSendEmailCodeRequest, this);
            return objTriggerSendEmailCode == objF ? objF : objTriggerSendEmailCode;
        }
    ...
    public TriggerSendEmailCodeRepository(SyncRestApiClientFactory syncRestApiClientFactory, g0 g0Var) {
        t.f(syncRestApiClientFactory, "restApiClientFactory");
        t.f(g0Var, "networkDispatcher");
        this.f39242a = syncRestApiClientFactory;
        this.f39243b = g0Var;
    }

    private final Result a(com.server.auditor.ssh.client.models.e eVar) {
        Object objB;
        Result.RecaptchaRequired recaptchaRequired;
        ...
        try {
            ...
            bVarS1.a();
            objB = bVarS1.b(SendEmailCodeBadRequest.Companion.serializer(), strString);
        } catch (IllegalArgumentException unused) {
            objB = null;
        }
        SendEmailCodeBadRequest sendEmailCodeBadRequest = (SendEmailCodeBadRequest) objB;
        if (sendEmailCodeBadRequest == null) {
            int iB = eVar.b();
            e0 e0VarA2 = ((h) eVar).a();
            String strString2 = e0VarA2 != null ? e0VarA2.string() : null;
            return new Result.Failed(iB, strString2 != null ? strString2 : "");
        }
        if (sendEmailCodeBadRequest.getRecaptchaRequired() != null && (recaptchaRequired = Result.RecaptchaRequired.INSTANCE) != null) {
            return recaptchaRequired;
        }
        String emailError = sendEmailCodeBadRequest.getEmailError();
        if (emailError == null) {
            emailError = "Enter a valid email address.";
        }
        return new Result.BadRequestMessage(emailError);
    }
    ...
    */
    public final java.lang.Object b(java.lang.String r7, java.lang.String r8, zt.e r9) {
        /*
            r6 = this;
            boolean r0 = r9 instanceof com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository.b
            if (r0 == 0) goto L13
            r0 = r9
            com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository$b r0 = (com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository.b) r0
            int r1 = r0.f39246c
            ...
            goto L18
        L13:
            com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository$b r0 = new com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository$b
            r0.<init>(r9)
        L18:
            java.lang.Object r9 = r0.f39244a
        ...
        L33:
            ut.x.b(r9)
            com.server.auditor.ssh.client.synchronization.retrofit.SyncRestApiClientFactory r9 = r6.f39242a
            com.server.auditor.ssh.client.synchronization.retrofit.SyncRestInterface r9 = r9.createRegularRestApiClient()
            wu.g0 r2 = r6.f39243b     // Catch: java.lang.Exception -> L29 java.io.IOException -> L67
            com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository$c r4 = new com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository$c     // Catch: java.lang.Exception -> L29 java.io.IOException -> L67
            r5 = 0
            r4.<init>(r9, r7, r8, r5)     // Catch: java.lang.Exception -> L29 java.io.IOException -> L67
            r0.f39246c = r3     // Catch: java.lang.Exception -> L29 java.io.IOException -> L67
        ...
        L4d:
            ...
            if (r7 == 0) goto L58
            com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository$Result$Success r7 = com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository.Result.Success.INSTANCE     // Catch: java.lang.Exception -> L29 java.io.IOException -> L67
            return r7
        L58:
            ...
            com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository$Result r7 = r6.a(r7)     // Catch: java.lang.Exception -> L29 java.io.IOException -> L67
            return r7
        L61:
            com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository$Result$Error r8 = new com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository$Result$Error
            r8.<init>(r7)
            goto L69
        L67:
            com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository$Result$NetworkError r8 = com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository.Result.NetworkError.INSTANCE
        L69:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.server.auditor.ssh.client.ui.auth.signup.data.TriggerSendEmailCodeRepository.b(java.lang.String, java.lang.String, zt.e):java.lang.Object");
    }
}
