...
public final class EndOfTrialTeamTrialStartedViewModel extends i1 {
    public static final int $stable = 8;
    private final d _screenActionFlow;
    private final w _uiState;
    private final Calendar grantedUntilDate;
    ...
    static final class b extends m implements p {
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final e create(Object obj, e eVar) {
            return EndOfTrialTeamTrialStartedViewModel.this.new b(eVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 == 0) {
                ...
                d dVar = EndOfTrialTeamTrialStartedViewModel.this._screenActionFlow;
                b.a aVar = b.a.f88043a;
                this.f39694a = 1;
    ...
    public EndOfTrialTeamTrialStartedViewModel(Calendar calendar) {
        t.f(calendar, "grantedUntilDate");
        this.grantedUntilDate = calendar;
        w wVarA = zu.m0.a(new s(calculateTrialDaysGranted(calendar)));
        this._uiState = wVarA;
    ...
    private final int calculateTrialDaysGranted(Calendar calendar) {
