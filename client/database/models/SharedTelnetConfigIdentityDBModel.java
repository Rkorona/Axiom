...
public final class SharedTelnetConfigIdentityDBModel extends SyncableModel implements ConfigIdentityDbModelInterface {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SharedTelnetConfigIdentityDBModel(Cursor cursor, s sVar) {
        super(cursor, sVar);
        t.f(cursor, "cursor");
        t.f(sVar, "cryptor");
