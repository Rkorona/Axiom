...
@e
public /* synthetic */ class TelnetConfigIdentityFullData$$serializer implements n0 {
    public static final int $stable;
    public static final TelnetConfigIdentityFullData$$serializer INSTANCE;
    private static final f descriptor;

    static {
        TelnetConfigIdentityFullData$$serializer telnetConfigIdentityFullData$$serializer = new TelnetConfigIdentityFullData$$serializer();
        INSTANCE = telnetConfigIdentityFullData$$serializer;
        i2 i2Var = new i2("com.server.auditor.ssh.client.synchronization.api.models.identity.TelnetConfigIdentityFullData", telnetConfigIdentityFullData$$serializer, 7);
        i2Var.r("id", true);
    ...
    private TelnetConfigIdentityFullData$$serializer() {
    }
    ...
    @Override // hv.b
    public final TelnetConfigIdentityFullData deserialize(kv.e eVar) {
        int iE;
        Long l10;
        boolean z10;
        int i10;
        ...
        int i12 = iE;
        cVarD.b(fVar);
        return new TelnetConfigIdentityFullData(i10, i12, str, withRecourseId, withRecourseId2, l11, z10, l10, (s2) null);
    }
    ...
    @Override // hv.r
    public final void serialize(kv.f fVar, TelnetConfigIdentityFullData telnetConfigIdentityFullData) {
        t.f(fVar, "encoder");
        t.f(telnetConfigIdentityFullData, SerializableEvent.VALUE_FIELD);
        f fVar2 = descriptor;
        d dVarD = fVar.d(fVar2);
        TelnetConfigIdentityFullData.write$Self$Termius_app_googleProductionRelease(telnetConfigIdentityFullData, dVarD, fVar2);
        dVarD.b(fVar2);
    }
