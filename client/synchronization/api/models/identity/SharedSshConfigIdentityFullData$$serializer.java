...
@e
public /* synthetic */ class SharedSshConfigIdentityFullData$$serializer implements n0 {
    public static final int $stable;
    public static final SharedSshConfigIdentityFullData$$serializer INSTANCE;
    private static final f descriptor;

    static {
        SharedSshConfigIdentityFullData$$serializer sharedSshConfigIdentityFullData$$serializer = new SharedSshConfigIdentityFullData$$serializer();
        INSTANCE = sharedSshConfigIdentityFullData$$serializer;
        i2 i2Var = new i2("com.server.auditor.ssh.client.synchronization.api.models.identity.SharedSshConfigIdentityFullData", sharedSshConfigIdentityFullData$$serializer, 7);
        i2Var.r("id", true);
    ...
    private SharedSshConfigIdentityFullData$$serializer() {
    }
    ...
    @Override // hv.b
    public final SharedSshConfigIdentityFullData deserialize(kv.e eVar) {
        int iE;
        Long l10;
        boolean z10;
        int i10;
        ...
        int i12 = iE;
        cVarD.b(fVar);
        return new SharedSshConfigIdentityFullData(i10, i12, str, withRecourseId, withRecourseId2, l11, z10, l10, (s2) null);
    }
    ...
    @Override // hv.r
    public final void serialize(kv.f fVar, SharedSshConfigIdentityFullData sharedSshConfigIdentityFullData) {
        t.f(fVar, "encoder");
        t.f(sharedSshConfigIdentityFullData, SerializableEvent.VALUE_FIELD);
        f fVar2 = descriptor;
        d dVarD = fVar.d(fVar2);
        SharedSshConfigIdentityFullData.write$Self$Termius_app_googleProductionRelease(sharedSshConfigIdentityFullData, dVarD, fVar2);
        dVarD.b(fVar2);
    }
