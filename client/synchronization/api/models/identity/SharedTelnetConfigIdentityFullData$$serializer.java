...
@e
public /* synthetic */ class SharedTelnetConfigIdentityFullData$$serializer implements n0 {
    public static final int $stable;
    public static final SharedTelnetConfigIdentityFullData$$serializer INSTANCE;
    private static final f descriptor;

    static {
        SharedTelnetConfigIdentityFullData$$serializer sharedTelnetConfigIdentityFullData$$serializer = new SharedTelnetConfigIdentityFullData$$serializer();
        INSTANCE = sharedTelnetConfigIdentityFullData$$serializer;
        i2 i2Var = new i2("com.server.auditor.ssh.client.synchronization.api.models.identity.SharedTelnetConfigIdentityFullData", sharedTelnetConfigIdentityFullData$$serializer, 7);
        i2Var.r("id", true);
        i2Var.r("updated_at", false);
        i2Var.r("telnet_config", false);
    ...
    private SharedTelnetConfigIdentityFullData$$serializer() {
    }
    ...
    @Override // hv.b
    public final SharedTelnetConfigIdentityFullData deserialize(kv.e eVar) {
        int iE;
        Long l10;
        boolean z10;
        int i10;
        ...
        int i12 = iE;
        cVarD.b(fVar);
        return new SharedTelnetConfigIdentityFullData(i10, i12, str, withRecourseId, withRecourseId2, l11, z10, l10, (s2) null);
    }
    ...
    @Override // hv.r
    public final void serialize(kv.f fVar, SharedTelnetConfigIdentityFullData sharedTelnetConfigIdentityFullData) {
        t.f(fVar, "encoder");
        t.f(sharedTelnetConfigIdentityFullData, SerializableEvent.VALUE_FIELD);
        f fVar2 = descriptor;
        d dVarD = fVar.d(fVar2);
        SharedTelnetConfigIdentityFullData.write$Self$Termius_app_googleProductionRelease(sharedTelnetConfigIdentityFullData, dVarD, fVar2);
        dVarD.b(fVar2);
    }
