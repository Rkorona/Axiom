...
@e
public /* synthetic */ class TelnetConfigIdentityBulk$$serializer implements n0 {
    ...
    static {
        ...
        i2 i2Var = new i2("com.server.auditor.ssh.client.synchronization.api.models.identity.TelnetConfigIdentityBulk", telnetConfigIdentityBulk$$serializer, 6);
    ...
    @Override // hv.b
    public final TelnetConfigIdentityBulk deserialize(kv.e eVar) {
        int i10;
        Object obj;
        Object obj2;
        Long l10;
        ...
        cVarD.b(fVar);
        return new TelnetConfigIdentityBulk(i10, obj, obj2, l10, l11, str, l12, (s2) null);
    }
    ...
    @Override // hv.r
    public final void serialize(kv.f fVar, TelnetConfigIdentityBulk telnetConfigIdentityBulk) {
        t.f(fVar, "encoder");
        t.f(telnetConfigIdentityBulk, SerializableEvent.VALUE_FIELD);
        f fVar2 = descriptor;
        d dVarD = fVar.d(fVar2);
        TelnetConfigIdentityBulk.write$Self$Termius_app_googleProductionRelease(telnetConfigIdentityBulk, dVarD, fVar2);
        dVarD.b(fVar2);
    }
