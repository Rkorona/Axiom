...
@e
public /* synthetic */ class TagHostFullData$$serializer implements n0 {
    public static final int $stable;
    public static final TagHostFullData$$serializer INSTANCE;
    private static final f descriptor;

    static {
        TagHostFullData$$serializer tagHostFullData$$serializer = new TagHostFullData$$serializer();
        INSTANCE = tagHostFullData$$serializer;
        i2 i2Var = new i2("com.server.auditor.ssh.client.synchronization.api.models.taghost.TagHostFullData", tagHostFullData$$serializer, 7);
        i2Var.r("id", false);
    ...
    private TagHostFullData$$serializer() {
    }
    ...
    public final c[] childSerializers() {
        ...
        return new c[]{w0.f64808a, x2.f64817a, withRecourseId$$serializer, withRecourseId$$serializer, cVarU, cVarU2, cVarU3};
    }

    @Override // hv.b
    public final TagHostFullData deserialize(kv.e eVar) {
        int iE;
        Long l10;
        int i10;
        String str;
        ...
        int i12 = iE;
        cVarD.b(fVar);
        return new TagHostFullData(i10, i12, str, withRecourseId, withRecourseId2, l11, bool, l10, (s2) null);
    }
    ...
    @Override // hv.r
    public final void serialize(kv.f fVar, TagHostFullData tagHostFullData) {
        t.f(fVar, "encoder");
        t.f(tagHostFullData, SerializableEvent.VALUE_FIELD);
        f fVar2 = descriptor;
        d dVarD = fVar.d(fVar2);
        TagHostFullData.write$Self$Termius_app_googleProductionRelease(tagHostFullData, dVarD, fVar2);
        dVarD.b(fVar2);
    }
