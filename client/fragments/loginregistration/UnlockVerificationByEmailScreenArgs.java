...
public class UnlockVerificationByEmailScreenArgs implements androidx.navigation.w {
    private final HashMap arguments;

    private UnlockVerificationByEmailScreenArgs() {
        this.arguments = new HashMap();
    }

    public static UnlockVerificationByEmailScreenArgs fromBundle(Bundle bundle) {
        UnlockVerificationByEmailScreenArgs unlockVerificationByEmailScreenArgs = new UnlockVerificationByEmailScreenArgs();
        bundle.setClassLoader(UnlockVerificationByEmailScreenArgs.class.getClassLoader());
        ...
        unlockVerificationByEmailScreenArgs.arguments.put("authenticationModel", authenticationModel);
        ...
        unlockVerificationByEmailScreenArgs.arguments.put("encodedPasswordHex", string);
        return unlockVerificationByEmailScreenArgs;
    }

    public static UnlockVerificationByEmailScreenArgs fromSavedStateHandle(androidx.lifecycle.u0 u0Var) {
        UnlockVerificationByEmailScreenArgs unlockVerificationByEmailScreenArgs = new UnlockVerificationByEmailScreenArgs();
        ...
        unlockVerificationByEmailScreenArgs.arguments.put("encodedPasswordHex", str);
        return unlockVerificationByEmailScreenArgs;
    }
    ...
    public boolean equals(Object obj) {
        ...
        UnlockVerificationByEmailScreenArgs unlockVerificationByEmailScreenArgs = (UnlockVerificationByEmailScreenArgs) obj;
        if (this.arguments.containsKey("authenticationModel") != unlockVerificationByEmailScreenArgs.arguments.containsKey("authenticationModel")) {
            return false;
        }
        if (getAuthenticationModel() == null ? unlockVerificationByEmailScreenArgs.getAuthenticationModel() != null : !getAuthenticationModel().equals(unlockVerificationByEmailScreenArgs.getAuthenticationModel())) {
            return false;
        }
        if (this.arguments.containsKey("encodedPasswordHex") != unlockVerificationByEmailScreenArgs.arguments.containsKey("encodedPasswordHex")) {
            return false;
        }
        return getEncodedPasswordHex() == null ? unlockVerificationByEmailScreenArgs.getEncodedPasswordHex() == null : getEncodedPasswordHex().equals(unlockVerificationByEmailScreenArgs.getEncodedPasswordHex());
    }
    ...
    public String toString() {
        return "UnlockVerificationByEmailScreenArgs{authenticationModel=" + getAuthenticationModel() + ", encodedPasswordHex=" + getEncodedPasswordHex() + "}";
    }

    private UnlockVerificationByEmailScreenArgs(HashMap map) {
