...
public class SignUpEnterPasswordScreenArgs implements androidx.navigation.w {
    private final HashMap arguments;

    private SignUpEnterPasswordScreenArgs() {
        this.arguments = new HashMap();
    }

    public static SignUpEnterPasswordScreenArgs fromBundle(Bundle bundle) {
        SignUpEnterPasswordScreenArgs signUpEnterPasswordScreenArgs = new SignUpEnterPasswordScreenArgs();
        bundle.setClassLoader(SignUpEnterPasswordScreenArgs.class.getClassLoader());
        ...
        signUpEnterPasswordScreenArgs.arguments.put("featureType", Integer.valueOf(bundle.getInt("featureType")));
        ...
        signUpEnterPasswordScreenArgs.arguments.put("authenticationModel", authenticationModel);
        ...
        signUpEnterPasswordScreenArgs.arguments.put("needCreateTrialAccount", Boolean.valueOf(bundle.getBoolean("needCreateTrialAccount")));
        ...
        signUpEnterPasswordScreenArgs.arguments.put("needSyncKeysAndPasswords", Boolean.valueOf(bundle.getBoolean("needSyncKeysAndPasswords")));
        return signUpEnterPasswordScreenArgs;
    }

    public static SignUpEnterPasswordScreenArgs fromSavedStateHandle(androidx.lifecycle.u0 u0Var) {
        SignUpEnterPasswordScreenArgs signUpEnterPasswordScreenArgs = new SignUpEnterPasswordScreenArgs();
        ...
        num.intValue();
        signUpEnterPasswordScreenArgs.arguments.put("featureType", num);
        ...
        bool.booleanValue();
        signUpEnterPasswordScreenArgs.arguments.put("needCreateTrialAccount", bool);
        if (!u0Var.b("needSyncKeysAndPasswords")) {
            throw new IllegalArgumentException("Required argument \"needSyncKeysAndPasswords\" is missing and does not have an android:defaultValue");
        }
        Boolean bool2 = (Boolean) u0Var.c("needSyncKeysAndPasswords");
        bool2.booleanValue();
        signUpEnterPasswordScreenArgs.arguments.put("needSyncKeysAndPasswords", bool2);
        return signUpEnterPasswordScreenArgs;
    }
    ...
    public boolean equals(Object obj) {
        ...
        SignUpEnterPasswordScreenArgs signUpEnterPasswordScreenArgs = (SignUpEnterPasswordScreenArgs) obj;
        if (this.arguments.containsKey("featureType") != signUpEnterPasswordScreenArgs.arguments.containsKey("featureType") || getFeatureType() != signUpEnterPasswordScreenArgs.getFeatureType() || this.arguments.containsKey("authenticationModel") != signUpEnterPasswordScreenArgs.arguments.containsKey("authenticationModel")) {
            return false;
        }
        if (getAuthenticationModel() == null ? signUpEnterPasswordScreenArgs.getAuthenticationModel() == null : getAuthenticationModel().equals(signUpEnterPasswordScreenArgs.getAuthenticationModel())) {
            return this.arguments.containsKey("needCreateTrialAccount") == signUpEnterPasswordScreenArgs.arguments.containsKey("needCreateTrialAccount") && getNeedCreateTrialAccount() == signUpEnterPasswordScreenArgs.getNeedCreateTrialAccount() && this.arguments.containsKey("needSyncKeysAndPasswords") == signUpEnterPasswordScreenArgs.arguments.containsKey("needSyncKeysAndPasswords") && getNeedSyncKeysAndPasswords() == signUpEnterPasswordScreenArgs.getNeedSyncKeysAndPasswords();
        }
        return false;
    }
    ...
    public String toString() {
        return "SignUpEnterPasswordScreenArgs{featureType=" + getFeatureType() + ", authenticationModel=" + getAuthenticationModel() + ", needCreateTrialAccount=" + getNeedCreateTrialAccount() + ", needSyncKeysAndPasswords=" + getNeedSyncKeysAndPasswords() + "}";
    }

    private SignUpEnterPasswordScreenArgs(HashMap map) {
