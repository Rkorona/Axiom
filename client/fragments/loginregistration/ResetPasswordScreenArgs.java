...
public class ResetPasswordScreenArgs implements androidx.navigation.w {
    private final HashMap arguments;

    private ResetPasswordScreenArgs() {
        this.arguments = new HashMap();
    }

    public static ResetPasswordScreenArgs fromBundle(Bundle bundle) {
        ResetPasswordScreenArgs resetPasswordScreenArgs = new ResetPasswordScreenArgs();
        bundle.setClassLoader(ResetPasswordScreenArgs.class.getClassLoader());
        ...
        resetPasswordScreenArgs.arguments.put("featureType", Integer.valueOf(bundle.getInt("featureType")));
        ...
        resetPasswordScreenArgs.arguments.put("authenticationModel", authenticationModel);
        ...
        resetPasswordScreenArgs.arguments.put("needCreateTrialAccount", Boolean.valueOf(bundle.getBoolean("needCreateTrialAccount")));
        ...
        resetPasswordScreenArgs.arguments.put("needSyncKeysAndPasswords", Boolean.valueOf(bundle.getBoolean("needSyncKeysAndPasswords")));
        return resetPasswordScreenArgs;
    }

    public static ResetPasswordScreenArgs fromSavedStateHandle(androidx.lifecycle.u0 u0Var) {
        ResetPasswordScreenArgs resetPasswordScreenArgs = new ResetPasswordScreenArgs();
        ...
        num.intValue();
        resetPasswordScreenArgs.arguments.put("featureType", num);
        ...
        bool.booleanValue();
        resetPasswordScreenArgs.arguments.put("needCreateTrialAccount", bool);
        if (!u0Var.b("needSyncKeysAndPasswords")) {
            throw new IllegalArgumentException("Required argument \"needSyncKeysAndPasswords\" is missing and does not have an android:defaultValue");
        }
        Boolean bool2 = (Boolean) u0Var.c("needSyncKeysAndPasswords");
        bool2.booleanValue();
        resetPasswordScreenArgs.arguments.put("needSyncKeysAndPasswords", bool2);
        return resetPasswordScreenArgs;
    }
    ...
    public boolean equals(Object obj) {
        ...
        ResetPasswordScreenArgs resetPasswordScreenArgs = (ResetPasswordScreenArgs) obj;
        if (this.arguments.containsKey("featureType") != resetPasswordScreenArgs.arguments.containsKey("featureType") || getFeatureType() != resetPasswordScreenArgs.getFeatureType() || this.arguments.containsKey("authenticationModel") != resetPasswordScreenArgs.arguments.containsKey("authenticationModel")) {
            return false;
        }
        if (getAuthenticationModel() == null ? resetPasswordScreenArgs.getAuthenticationModel() == null : getAuthenticationModel().equals(resetPasswordScreenArgs.getAuthenticationModel())) {
            return this.arguments.containsKey("needCreateTrialAccount") == resetPasswordScreenArgs.arguments.containsKey("needCreateTrialAccount") && getNeedCreateTrialAccount() == resetPasswordScreenArgs.getNeedCreateTrialAccount() && this.arguments.containsKey("needSyncKeysAndPasswords") == resetPasswordScreenArgs.arguments.containsKey("needSyncKeysAndPasswords") && getNeedSyncKeysAndPasswords() == resetPasswordScreenArgs.getNeedSyncKeysAndPasswords();
        }
        return false;
    }
    ...
    public String toString() {
        return "ResetPasswordScreenArgs{featureType=" + getFeatureType() + ", authenticationModel=" + getAuthenticationModel() + ", needCreateTrialAccount=" + getNeedCreateTrialAccount() + ", needSyncKeysAndPasswords=" + getNeedSyncKeysAndPasswords() + "}";
    }

    private ResetPasswordScreenArgs(HashMap map) {
