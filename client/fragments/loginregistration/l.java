...
public abstract class l {
    ...
    public static class a implements k1 {
        ...
        private final HashMap f25937a;

        @Override // androidx.navigation.k1
        public Bundle a() {
            Bundle bundle = new Bundle();
            if (this.f25937a.containsKey("emailAuthentication")) {
                EmailAuthentication emailAuthentication = (EmailAuthentication) this.f25937a.get("emailAuthentication");
            ...
            if (this.f25937a.containsKey("encodedPasswordHex")) {
                bundle.putString("encodedPasswordHex", (String) this.f25937a.get("encodedPasswordHex"));
            }
            return bundle;
        }
        ...
        @Override // androidx.navigation.k1
        public int b() {
            return R.id.action_masterPasswordUnlockVerificationByEmailScreen_to_masterPasswordRequireTwoFactorCode;
        }

        public EmailAuthentication c() {
            return (EmailAuthentication) this.f25937a.get("emailAuthentication");
        }

        public String d() {
            return (String) this.f25937a.get("encodedPasswordHex");
        }
        ...
        public boolean equals(Object obj) {
            ...
            a aVar = (a) obj;
            if (this.f25937a.containsKey("emailAuthentication") != aVar.f25937a.containsKey("emailAuthentication")) {
                return false;
            }
            if (c() == null ? aVar.c() != null : !c().equals(aVar.c())) {
                return false;
            }
            if (this.f25937a.containsKey("encodedPasswordHex") != aVar.f25937a.containsKey("encodedPasswordHex")) {
                return false;
            }
        ...
        public String toString() {
            return "ActionMasterPasswordUnlockVerificationByEmailScreenToMasterPasswordRequireTwoFactorCode(actionId=" + b() + "){emailAuthentication=" + c() + ", encodedPasswordHex=" + d() + "}";
        }
