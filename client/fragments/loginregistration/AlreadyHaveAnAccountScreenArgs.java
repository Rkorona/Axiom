...
public class AlreadyHaveAnAccountScreenArgs implements androidx.navigation.w {
    private final HashMap arguments;

    private AlreadyHaveAnAccountScreenArgs() {
        this.arguments = new HashMap();
    }

    public static AlreadyHaveAnAccountScreenArgs fromBundle(Bundle bundle) {
        AlreadyHaveAnAccountScreenArgs alreadyHaveAnAccountScreenArgs = new AlreadyHaveAnAccountScreenArgs();
        bundle.setClassLoader(AlreadyHaveAnAccountScreenArgs.class.getClassLoader());
        ...
        alreadyHaveAnAccountScreenArgs.arguments.put("featureType", Integer.valueOf(bundle.getInt("featureType")));
        ...
        alreadyHaveAnAccountScreenArgs.arguments.put("authenticationModel", authenticationModel);
        ...
        alreadyHaveAnAccountScreenArgs.arguments.put("needCreateTrialAccount", Boolean.valueOf(bundle.getBoolean("needCreateTrialAccount")));
        ...
        alreadyHaveAnAccountScreenArgs.arguments.put("needSyncKeysAndPasswords", Boolean.valueOf(bundle.getBoolean("needSyncKeysAndPasswords")));
        return alreadyHaveAnAccountScreenArgs;
    }

    public static AlreadyHaveAnAccountScreenArgs fromSavedStateHandle(androidx.lifecycle.u0 u0Var) {
        AlreadyHaveAnAccountScreenArgs alreadyHaveAnAccountScreenArgs = new AlreadyHaveAnAccountScreenArgs();
        ...
        num.intValue();
        alreadyHaveAnAccountScreenArgs.arguments.put("featureType", num);
        ...
        bool.booleanValue();
        alreadyHaveAnAccountScreenArgs.arguments.put("needCreateTrialAccount", bool);
        if (!u0Var.b("needSyncKeysAndPasswords")) {
            throw new IllegalArgumentException("Required argument \"needSyncKeysAndPasswords\" is missing and does not have an android:defaultValue");
        }
        Boolean bool2 = (Boolean) u0Var.c("needSyncKeysAndPasswords");
        bool2.booleanValue();
        alreadyHaveAnAccountScreenArgs.arguments.put("needSyncKeysAndPasswords", bool2);
        return alreadyHaveAnAccountScreenArgs;
    }
    ...
    public boolean equals(Object obj) {
        ...
        AlreadyHaveAnAccountScreenArgs alreadyHaveAnAccountScreenArgs = (AlreadyHaveAnAccountScreenArgs) obj;
        if (this.arguments.containsKey("featureType") != alreadyHaveAnAccountScreenArgs.arguments.containsKey("featureType") || getFeatureType() != alreadyHaveAnAccountScreenArgs.getFeatureType() || this.arguments.containsKey("authenticationModel") != alreadyHaveAnAccountScreenArgs.arguments.containsKey("authenticationModel")) {
            return false;
        }
        if (getAuthenticationModel() == null ? alreadyHaveAnAccountScreenArgs.getAuthenticationModel() == null : getAuthenticationModel().equals(alreadyHaveAnAccountScreenArgs.getAuthenticationModel())) {
            return this.arguments.containsKey("needCreateTrialAccount") == alreadyHaveAnAccountScreenArgs.arguments.containsKey("needCreateTrialAccount") && getNeedCreateTrialAccount() == alreadyHaveAnAccountScreenArgs.getNeedCreateTrialAccount() && this.arguments.containsKey("needSyncKeysAndPasswords") == alreadyHaveAnAccountScreenArgs.arguments.containsKey("needSyncKeysAndPasswords") && getNeedSyncKeysAndPasswords() == alreadyHaveAnAccountScreenArgs.getNeedSyncKeysAndPasswords();
        }
        return false;
    }
    ...
    public String toString() {
        return "AlreadyHaveAnAccountScreenArgs{featureType=" + getFeatureType() + ", authenticationModel=" + getAuthenticationModel() + ", needCreateTrialAccount=" + getNeedCreateTrialAccount() + ", needSyncKeysAndPasswords=" + getNeedSyncKeysAndPasswords() + "}";
    }

    private AlreadyHaveAnAccountScreenArgs(HashMap map) {
