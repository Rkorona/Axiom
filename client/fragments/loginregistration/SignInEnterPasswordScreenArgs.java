...
public class SignInEnterPasswordScreenArgs implements androidx.navigation.w {
    private final HashMap arguments;

    private SignInEnterPasswordScreenArgs() {
        this.arguments = new HashMap();
    }

    public static SignInEnterPasswordScreenArgs fromBundle(Bundle bundle) {
        SignInEnterPasswordScreenArgs signInEnterPasswordScreenArgs = new SignInEnterPasswordScreenArgs();
        bundle.setClassLoader(SignInEnterPasswordScreenArgs.class.getClassLoader());
        ...
        signInEnterPasswordScreenArgs.arguments.put("featureType", Integer.valueOf(bundle.getInt("featureType")));
        ...
        signInEnterPasswordScreenArgs.arguments.put("authenticationModel", authenticationModel);
        ...
        signInEnterPasswordScreenArgs.arguments.put("needCreateTrialAccount", Boolean.valueOf(bundle.getBoolean("needCreateTrialAccount")));
        ...
        signInEnterPasswordScreenArgs.arguments.put("needSyncKeysAndPasswords", Boolean.valueOf(bundle.getBoolean("needSyncKeysAndPasswords")));
        return signInEnterPasswordScreenArgs;
    }

    public static SignInEnterPasswordScreenArgs fromSavedStateHandle(androidx.lifecycle.u0 u0Var) {
        SignInEnterPasswordScreenArgs signInEnterPasswordScreenArgs = new SignInEnterPasswordScreenArgs();
        ...
        num.intValue();
        signInEnterPasswordScreenArgs.arguments.put("featureType", num);
        ...
        bool.booleanValue();
        signInEnterPasswordScreenArgs.arguments.put("needCreateTrialAccount", bool);
        if (!u0Var.b("needSyncKeysAndPasswords")) {
            throw new IllegalArgumentException("Required argument \"needSyncKeysAndPasswords\" is missing and does not have an android:defaultValue");
        }
        Boolean bool2 = (Boolean) u0Var.c("needSyncKeysAndPasswords");
        bool2.booleanValue();
        signInEnterPasswordScreenArgs.arguments.put("needSyncKeysAndPasswords", bool2);
        return signInEnterPasswordScreenArgs;
    }
    ...
    public boolean equals(Object obj) {
        ...
        SignInEnterPasswordScreenArgs signInEnterPasswordScreenArgs = (SignInEnterPasswordScreenArgs) obj;
        if (this.arguments.containsKey("featureType") != signInEnterPasswordScreenArgs.arguments.containsKey("featureType") || getFeatureType() != signInEnterPasswordScreenArgs.getFeatureType() || this.arguments.containsKey("authenticationModel") != signInEnterPasswordScreenArgs.arguments.containsKey("authenticationModel")) {
            return false;
        }
        if (getAuthenticationModel() == null ? signInEnterPasswordScreenArgs.getAuthenticationModel() == null : getAuthenticationModel().equals(signInEnterPasswordScreenArgs.getAuthenticationModel())) {
            return this.arguments.containsKey("needCreateTrialAccount") == signInEnterPasswordScreenArgs.arguments.containsKey("needCreateTrialAccount") && getNeedCreateTrialAccount() == signInEnterPasswordScreenArgs.getNeedCreateTrialAccount() && this.arguments.containsKey("needSyncKeysAndPasswords") == signInEnterPasswordScreenArgs.arguments.containsKey("needSyncKeysAndPasswords") && getNeedSyncKeysAndPasswords() == signInEnterPasswordScreenArgs.getNeedSyncKeysAndPasswords();
        }
        return false;
    }
    ...
    public String toString() {
        return "SignInEnterPasswordScreenArgs{featureType=" + getFeatureType() + ", authenticationModel=" + getAuthenticationModel() + ", needCreateTrialAccount=" + getNeedCreateTrialAccount() + ", needSyncKeysAndPasswords=" + getNeedSyncKeysAndPasswords() + "}";
    }

    private SignInEnterPasswordScreenArgs(HashMap map) {
