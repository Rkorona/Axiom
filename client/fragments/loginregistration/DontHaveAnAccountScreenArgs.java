...
public class DontHaveAnAccountScreenArgs implements androidx.navigation.w {
    private final HashMap arguments;

    private DontHaveAnAccountScreenArgs() {
        this.arguments = new HashMap();
    }

    public static DontHaveAnAccountScreenArgs fromBundle(Bundle bundle) {
        DontHaveAnAccountScreenArgs dontHaveAnAccountScreenArgs = new DontHaveAnAccountScreenArgs();
        bundle.setClassLoader(DontHaveAnAccountScreenArgs.class.getClassLoader());
        ...
        dontHaveAnAccountScreenArgs.arguments.put("featureType", Integer.valueOf(bundle.getInt("featureType")));
        ...
        dontHaveAnAccountScreenArgs.arguments.put("authenticationModel", authenticationModel);
        ...
        dontHaveAnAccountScreenArgs.arguments.put("needCreateTrialAccount", Boolean.valueOf(bundle.getBoolean("needCreateTrialAccount")));
        ...
        dontHaveAnAccountScreenArgs.arguments.put("needSyncKeysAndPasswords", Boolean.valueOf(bundle.getBoolean("needSyncKeysAndPasswords")));
        return dontHaveAnAccountScreenArgs;
    }

    public static DontHaveAnAccountScreenArgs fromSavedStateHandle(androidx.lifecycle.u0 u0Var) {
        DontHaveAnAccountScreenArgs dontHaveAnAccountScreenArgs = new DontHaveAnAccountScreenArgs();
        ...
        num.intValue();
        dontHaveAnAccountScreenArgs.arguments.put("featureType", num);
        ...
        bool.booleanValue();
        dontHaveAnAccountScreenArgs.arguments.put("needCreateTrialAccount", bool);
        if (!u0Var.b("needSyncKeysAndPasswords")) {
            throw new IllegalArgumentException("Required argument \"needSyncKeysAndPasswords\" is missing and does not have an android:defaultValue");
        }
        Boolean bool2 = (Boolean) u0Var.c("needSyncKeysAndPasswords");
        bool2.booleanValue();
        dontHaveAnAccountScreenArgs.arguments.put("needSyncKeysAndPasswords", bool2);
        return dontHaveAnAccountScreenArgs;
    }
    ...
    public boolean equals(Object obj) {
        ...
        DontHaveAnAccountScreenArgs dontHaveAnAccountScreenArgs = (DontHaveAnAccountScreenArgs) obj;
        if (this.arguments.containsKey("featureType") != dontHaveAnAccountScreenArgs.arguments.containsKey("featureType") || getFeatureType() != dontHaveAnAccountScreenArgs.getFeatureType() || this.arguments.containsKey("authenticationModel") != dontHaveAnAccountScreenArgs.arguments.containsKey("authenticationModel")) {
            return false;
        }
        if (getAuthenticationModel() == null ? dontHaveAnAccountScreenArgs.getAuthenticationModel() == null : getAuthenticationModel().equals(dontHaveAnAccountScreenArgs.getAuthenticationModel())) {
            return this.arguments.containsKey("needCreateTrialAccount") == dontHaveAnAccountScreenArgs.arguments.containsKey("needCreateTrialAccount") && getNeedCreateTrialAccount() == dontHaveAnAccountScreenArgs.getNeedCreateTrialAccount() && this.arguments.containsKey("needSyncKeysAndPasswords") == dontHaveAnAccountScreenArgs.arguments.containsKey("needSyncKeysAndPasswords") && getNeedSyncKeysAndPasswords() == dontHaveAnAccountScreenArgs.getNeedSyncKeysAndPasswords();
        }
        return false;
    }
    ...
    public String toString() {
        return "DontHaveAnAccountScreenArgs{featureType=" + getFeatureType() + ", authenticationModel=" + getAuthenticationModel() + ", needCreateTrialAccount=" + getNeedCreateTrialAccount() + ", needSyncKeysAndPasswords=" + getNeedSyncKeysAndPasswords() + "}";
    }

    private DontHaveAnAccountScreenArgs(HashMap map) {
