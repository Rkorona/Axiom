...
public abstract class r0 {
    public static final List a(Context context, Menu menu) {
        ...
        a.b bVarA = com.server.auditor.ssh.client.navigation.ui.compose.b.a(menu, R.id.connect, string, Integer.valueOf(R.drawable.ic_connect));
        if (bVarA != null) {
            arrayList.add(bVarA);
        }
        String string2 = context.getString(R.string.disconnect);
        ju.t.e(string2, "getString(...)");
        a.b bVarA2 = com.server.auditor.ssh.client.navigation.ui.compose.b.a(menu, R.id.close_host, string2, Integer.valueOf(R.drawable.ic_disconnect));
        if (bVarA2 != null) {
