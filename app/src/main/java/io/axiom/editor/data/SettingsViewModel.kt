...
class SettingsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun setEditorThemeLight(v: EditorThemeMode) = update(settings.copy(editorThemeLight = v))
    fun setEditorThemeDark(v: EditorThemeMode)  = update(settings.copy(editorThemeDark = v))
